...
const projects = [
  {
    ...
    target: 'Schools and educational institutions which want to bring their students into a the digital world with guidance and support.',
    ...
    description: 'An onboarding social media app educating students in schools for the 21st Century education.',
  ...
  },
  {
    ...
    target: 'The idea behind this project was to help support nursing staff in hospitals, specifically the lead and member nurses.',
    ...
    description: 'An app which helps solve task management and communicaton issues within hospitals.',
  ...
  },
  {
    ...
    target: 'People who enjoy cocktails with an exciting UI.',
    ...
    description: 'Cocktail app primarily exploring MVC framework, built with Ruby on Rails and JavaScript packages.',
  ...
  },
  {
    ...
    target: 'Farmers and members of the local community who enjoy fresh vegetables, care about sustainabilty, and supporting the local economy.',
